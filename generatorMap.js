...
async function getGenerators() {
  ...
  for (i in generators) {
    ...
    capacityCircle = turf.circle(
      [parseFloat(generators[i].lon), parseFloat(generators[i].lat)],
      capacityCircleRadius,
      circleOptions
    );
    capacityCircle.properties.name = generators[i].siteName;
    capacityCircle.properties.installedCapacity =
      generators[i].installedCapacity;
    ...
    capacityCircle.properties.LngLatLike = [
      parseFloat(generators[i].lon),
      parseFloat(generators[i].lat),
    ];
